...
Measurements_received=find(conn,CollName,'Query',['{"DocType":"Measurements_received"}']);
...
MPC_KalFil=find(conn,CollName,'Query',['{"DocType":"MPC_KalFil_status"}']);
...
save([CollName '.mat'],'RecvSettings','SimData','Measurements','Measurements_received','Measurements_MPC',...
    'SupvCtrlSig','SupvCtrlSig_GEB','MPC_debugdata','MPC_KalFil','OccupantMatrix','EPlusOutput','HardwareData',...
