...
if isempty(n)
    ...
    VminOfficeTyp=[23 2 2 10;35 3 3 15]*20;   % Office minimum ventilation rate in typical control,20cfm/person [cfm] (change the minimum ventilation of ConfRoom back to 460 cfm, YC 2023/08/20)
%     VminOfficeTyp=[10 2 2 10;35 3 3 15]*20; % for MPC cases, the minimum ventilation of conference room is 200 cfm
