...
Measurements_MPC=find(conn,CollName,'Query',['{"DocType":"Measurements_MPC"}']);
SupvCtrlSig=find(conn,CollName,'Query',['{"DocType":"SupvCtrlSig"}']);
SupvCtrlSig_GEB=find(conn,CollName,'Query',['{"DocType":"SuperCtrlSig_GEB"}']);

x_opt=find(conn,CollName,'Query',['{"DocType":"x_opt"}']);
MPC_DebugData=find(conn,CollName,'Query',['{"DocType":"MPC_DebugData"}']);
...
% WSHP_Spt_Estimator_debug data
WSHP_Spt_Estimator_debug=load('WSHP_Spt_Estimator_debug.mat').WSHP_Spt_Estimator_debug;
% save data to mat file
save([CollName '.mat'],'RecvSettings','SimData','Measurements','Measurements_MPC',...
    'SupvCtrlSig','SupvCtrlSig_GEB','x_opt','MPC_DebugData','OccupantMatrix','EPlusOutput','HardwareData',...
    'settings','WSHP_Spt_Estimator_debug');
end