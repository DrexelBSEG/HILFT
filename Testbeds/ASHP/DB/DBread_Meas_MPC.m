...
block.OutputPort(1).Dimensions       = [1,5]; 
...
if isempty(CollName)
    ...
    % based on the timestep to read the measurements for MPC (ZC 2023/3/6)
...
block.OutputPort(1).Data(1,:) = [Meas_query.T_sup,SimData_query.T_z,...
                                 Meas_query.w_sup,SimData_query.w_z,Meas_query.m_sup];
%end Outputs
